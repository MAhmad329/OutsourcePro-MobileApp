...
import 'package:outsourcepro/screens/freelancer/see_all_results_chat.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            'Search for Freelancers to chat',
            style: TextStyle(
                fontSize: 16.sp,
                color: Colors.black,
                                  ...
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => ChatScreen(
                                              receiverId: freelancers[index].id,
                                              username: freelancers[index]
                                                  .username)));
                                },
                                child: ListTile(
